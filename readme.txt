...
* Russian translation provided by [Igor](http://arahis.com)
...
* Added the '' filter for truncate the comment title.
...
= 1.6.0 =
This release adds the '' filter for truncate the comment title if needed.
